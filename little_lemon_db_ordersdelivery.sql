...
CREATE TABLE `ordersdelivery` (
  ...
  KEY `OrderDate_fk_idx` (`OrderDate`),
  CONSTRAINT `OrderDate_fk` FOREIGN KEY (`OrderDate`) REFERENCES `orders` (`OrderDate`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-11-12  8:26:57
